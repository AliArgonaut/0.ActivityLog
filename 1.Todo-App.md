...
## 5-20-24
today I updated the tasks remaining header to reflect the number of tasks currently displayed. I also made it grammatically correct, so one task left would say "task" instead of "tasks". Also created an isCompleted function, but havent implemented it yet. 
